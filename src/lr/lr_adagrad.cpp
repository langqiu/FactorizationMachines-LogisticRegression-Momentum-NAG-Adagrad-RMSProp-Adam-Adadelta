...
namespace model {
  ...
  LRAdagradModel::LRAdagradModel(DataSet* p_train_dataset, DataSet* p_test_dataset,
  ...
  void LRAdagradModel::_backward(const size_t& l, const size_t& r) {
    /*
